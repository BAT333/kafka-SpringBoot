...
public class ConsumerKafkaConfig {
    ...
    public KafkaStreamsConfiguration configuration(){
        ...
        configProps.put(APPLICATION_ID_CONFIG , "kafka-streams-demo-6");
        configProps.put(BOOTSTRAP_SERVERS_CONFIG, this.bootstrapAddress);
        configProps.put(DEFAULT_KEY_SERDE_CLASS_CONFIG, Serdes.String().getClass().getName());
        configProps.put(DEFAULT_VALUE_SERDE_CLASS_CONFIG, PixSerdes.class);
